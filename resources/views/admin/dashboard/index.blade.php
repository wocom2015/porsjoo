...
</svg><!--end::Svg Icon--></span>        <div class="text-inverse-danger font-weight-bolder font-size-h5 mb-2 mt-5">{{$stats['plansCount']}}</div>
                    <div class="font-weight-bold text-inverse-danger font-size-sm">تعداد طرح ها</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::آمار Widget 13-->
...
</svg><!--end::Svg Icon--></span>        <div class="text-inverse-primary font-weight-bolder font-size-h5 mb-2 mt-5">{{$stats['usersCount']}}</div>
                    <div class="font-weight-bold text-inverse-primary font-size-sm">تعداد کاربران</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::آمار Widget 14-->
...
</svg><!--end::Svg Icon--></span>        <div class="text-inverse-success font-weight-bolder font-size-h5 mb-2 mt-5">{{$stats['inquiriesCount']}}</div>
