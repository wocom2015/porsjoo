...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="content-frame"><div class="row p-2"><div class="col-lg-12"><h1>استعلام های متناسب با حرفه شما : ${ssrInterpolate(this.count)} مورد</h1></div></div><div class="row" style="${ssrRenderStyle({ "background-color": "#f0f0f0", "padding": "10px" })}"><div class="col">استان</div><div class="col">محصول</div><div class="col">تاریخ</div><div class="col">مشاهده مشخصات</div><div class="col">پاسخ شما</div><div class="col">پاسخ مشتری</div><div class="col">گفتگو</div></div>`);
  if (this.count > 0) {
    _push(`<!--[-->`);
    ssrRenderList(this.inquiries, (item) => {
