...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
    _push(`<div${ssrRenderAttrs(_attrs)}><div class="content-frame"><div class="row" style="${ssrRenderStyle({
        ...
        "padding": "10px"
    })}"><div class="col">استان</div><div class="col">محصول</div><div class="col">تاریخ</div><div class="col">مشاهده مشخصات</div><div class="col">پاسخ شما</div><div class="col">پاسخ مشتری</div><div class="col">گفتگو</div></div>`);
    if (this.count > 0) {
        _push(`<!--[-->`);
        ssrRenderList(this.inquiries, (item) => {
            _push(`<div class="row mb-2 p-2"><div class="col">${ssrInterpolate(item.provinceName)}</div><div class="col"><strong>${ssrInterpolate(item.name)}</strong></div><div class="col">${ssrInterpolate(item.created)}</div><div class="col"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}" src="/site/images/view_pj.png">مشاهده</button></div><div class="col" style="${ssrRenderStyle(item.reply_by_user == 0 ? null : {display: "none"})}"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}" src="/site/images/view_pj.png"> مشاهده</button></div><div style="${ssrRenderStyle(item.reply_by_user == 1 ? null : {display: "none"})}" class="col"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}" src="/site/images/view_pj.png"> مشاهده</button></div><div class="col"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}" src="/site/images/view_pj.png"> مشاهده</button></div><div class="col"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}" src="/site/images/view_pj.png"> مشاهده</button></div></div>`);
        });
        _push(`<!--]-->`);
    } else {
        _push(`<!---->`);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
    _push(`<div${ssrRenderAttrs(_attrs)}><div class="row p-2"><div class="col-lg-3"><strong><a href="/inquiry/report" class="text-success">گزارش</a></strong></div></div><div class="row" style="${ssrRenderStyle({
        "background-color": "#f0f0f0",
        "padding": "10px"
    })}"><div class="col-lg-2">شناسه استعلام</div><div class="col-lg-2">نام محصول</div><div class="col-lg-2">تاریخ</div><div class="col-lg-2">دسته بندی</div><div class="col-lg-2">مشخصات</div><div class="col-lg-2">پاسخ ها</div></div>`);
    if (this.count > 0) {
        _push(`<!--[-->`);
        ssrRenderList(this.inquiries, (item) => {
            _push(`<div class="row mb-2 p-2"><div class="col-lg-2">${ssrInterpolate(item.id)}</div><div class="col-lg-2">${ssrInterpolate(item.name)}</div><div class="col-lg-2">${ssrInterpolate(item.created)}</div><div class="col-lg-2">${ssrInterpolate(item.categoryName)}</div><div class="col-lg-2"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}" src="/site/images/view_pj.png"> مشاهده </button></div><div class="col-lg-2"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}" src="/site/images/view_pj.png"> مشاهده (${ssrInterpolate(item.repliesCount)}) </button></div></div>`);
        });
        _push(`<!--]-->`);
    } else {
        _push(`<!---->`);
                ...
                ssrRenderList($props.slides, (slide) => {
                    _push2(ssrRenderComponent(_component_slide, {key: slide}, {
                        default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                            if (_push3) {
                                _push3(`<img${ssrRenderAttr("src", slide.url)} width="250" height="250"${_scopeId2}>`);
                            } else {
                                return [
                                    createVNode("img", {
                                        src: slide.url,
...
const sliderComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
const app = createApp({
    components: {
        searchComponent,
        dateComponent,
