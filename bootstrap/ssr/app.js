...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="content-frame"><div class="row p-2"><div class="col-lg-12"><h1>استعلام های متناسب با حرفه شما : ${ssrInterpolate(this.count)} مورد</h1></div></div><div class="row" style="${ssrRenderStyle({ "background-color": "#f0f0f0", "padding": "10px" })}"><div class="col-lg-2">استان</div><div class="col-lg-2">محصول</div><div class="col-lg-2">تاریخ</div><div class="col-lg-2">مشاهده مشخصات</div><div class="col-lg-2">پاسخ شما</div><div class="col-lg-2">پاسخ مشتری</div></div>`);
  if (this.count > 0) {
    _push(`<!--[-->`);
    ssrRenderList(this.inquiries, (item) => {
      _push(`<div class="row mb-2 p-2"><div class="col-lg-2">${ssrInterpolate(item.provinceName)}</div><div class="col-lg-2"><strong>${ssrInterpolate(item.name)}</strong></div><div class="col-lg-2">${ssrInterpolate(item.created)}</div><div class="col-lg-2"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({ "width": "12px", "color": "orange" })}" src="/site/images/view_pj.png">مشاهده</button></div><div style="${ssrRenderStyle(item.reply_by_user == 0 ? null : { display: "none" })}" class="col-lg-2"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({ "width": "12px", "color": "orange" })}" src="/site/images/view_pj.png"> مشاهده</button></div><div style="${ssrRenderStyle(item.reply_by_user == 1 ? null : { display: "none" })}" class="col-lg-2"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({ "width": "12px", "color": "orange" })}" src="/site/images/view_pj.png"> مشاهده</button></div><div style="${ssrRenderStyle(item.reply_by_user == 1 ? null : { display: "none" })}" class="col-lg-2"><button class="btn-no-bordered mb-1"><img style="${ssrRenderStyle({ "width": "12px", "color": "orange" })}" src="/site/images/view_pj.png"> مشاهده</button></div></div>`);
    });
    _push(`<!--]-->`);
  } else {
    _push(`<!---->`);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="row p-2"><div class="col-lg-3"><h1>استعلام های ارسالی شما : ${ssrInterpolate(this.count)} مورد</h1></div><div class="col-lg-3"><strong><a href="/inquiry/report" class="text-success">گزارش</a></strong></div></div><div class="row" style="${ssrRenderStyle({ "background-color": "#f0f0f0", "padding": "10px" })}"><div class="col-lg-2">شناسه استعلام</div><div class="col-lg-2">نام محصول</div><div class="col-lg-2">تاریخ</div><div class="col-lg-2">دسته بندی</div><div class="col-lg-2">مشخصات</div><div class="col-lg-2">پاسخ ها</div></div>`);
  if (this.count > 0) {
    _push(`<!--[-->`);
    ssrRenderList(this.inquiries, (item) => {
