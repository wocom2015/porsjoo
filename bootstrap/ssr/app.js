    ...
    if (this.count > 0) {
        ...
        ssrRenderList(this.inquiries, (item) => {
            _push(`<div class="the-row the-flex"><div class="the-flex-item the-flex-item-1">${ssrInterpolate(item.provinceName)}</div><div class="the-flex-item the-flex-item-1 col-header">استان</div><div class="the-flex-item the-flex-item-2"><strong>${ssrInterpolate(item.name)}</strong></div><div class="the-flex-item the-flex-item-2 col-header">محصول</div><div class="the-flex-item the-flex-item-3">${ssrInterpolate(item.created)}</div><div class="the-flex-item the-flex-item-3 col-header">تاریخ</div><div class="the-flex-item the-flex-item-4"><button class="btn-no-bordered mb-1"><img src="/site/images/view_pj.png" style="${ssrRenderStyle({
                ...
                "width": "12px",
                "color": "orange"
            })}"> مشاهده </button></div><div class="the-flex-item the-flex-item-5 col-header">پاسخ شما</div><div class="the-flex-item the-flex-item-6"><button style="${ssrRenderStyle(item.reply_by_user == 1 ? null : {display: "none"})}" class="btn-no-bordered mb-1"><img src="/site/images/view_pj.png" style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}"> مشاهده </button></div><div class="the-flex-item the-flex-item-6 col-header">پاسخ مشتری</div><div class="the-flex-item the-flex-item-7"><button class="btn-no-bordered mb-1"><img src="/site/images/view_pj.png" style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}"> مشاهده </button></div><div class="the-flex-item the-flex-item-7 col-header">گفتگو</div><div class="the-flex-item the-flex-item-8"><button class="btn-no-bordered mb-1"><img src="/site/images/view_pj.png" style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
            })}"> مشاهده </button></div><div class="the-flex-item the-flex-item-8 col-header">گفتگو</div></div>`);
        });
        _push(`<!--]-->`);
    } else {
        _push(`<!---->`);
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
    _push(`<div${ssrRenderAttrs(mergeProps({class: "am-sent-table"}, _attrs))}><div class="the-table the-flex"><div class="row p-2"><div class="col-lg-3"><strong><a class="text-success" href="/inquiry/report">گزارش</a></strong></div></div><div class="the-header the-flex" style="${ssrRenderStyle({
        "background-color": "#f0f0f0",
        "padding": "10px"
    ...
    if (this.count > 0) {
        _push(`<!--[-->`);
        ssrRenderList(this.inquiries, (item) => {
            _push(`<div class="the-row the-flex"><div class="the-flex-item the-flex-item-1">${ssrInterpolate(item.id)}</div><div class="the-flex-item the-flex-item-1-1 col-header">شناسه استعلام</div><div class="the-flex-item the-flex-item-2">${ssrInterpolate(item.name)}</div><div class="the-flex-item the-flex-item-2-1 col-header">نام محصول</div><div class="the-flex-item the-flex-item-3">${ssrInterpolate(item.created)}</div><div class="the-flex-item the-flex-item-3-1 col-header">تاریخ</div><div class="the-flex-item the-flex-item-4">${ssrInterpolate(item.categoryName)}</div><div class="the-flex-item the-flex-item-4-1 col-header">دسته بندی</div><div class="the-flex-item the-flex-item-5"><button class="btn-no-bordered mb-1"><img src="/site/images/view_pj.png" style="${ssrRenderStyle({
                "width": "12px",
                "color": "orange"
